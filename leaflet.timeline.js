! function(t) {
    ...
    i.TimelineSliderControl = i.Control.extend({
        ...
        _setTime: function(t, e) {
            this.time = t, this.options.waitToUpdateMap && "change" !== e || this.timelines.forEach((function(e) {
                return e.setTime(t)
        ...
        setTime: function(t) {
            this._timeSlider && (this._timeSlider.value = t.toString()), this._setTime(t, "change")
        },
        onAdd: function(t) {
